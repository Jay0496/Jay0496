...
- Currently a Software Engineer Intern at MDA Space
- Previous Software Developer (Part-time Contract) at AI Model Tech Inc.
- Previous Networking Lab Technician at SAIN Labs (Ontario Tech University)
...
- AI & Integration: RAG architectures, vector databases, local LLM integrations, and embedded AI capabilities.
- Embedded & Robotics: Bare-metal development, real-time systems, hardware-software integration, and robotics platforms.
